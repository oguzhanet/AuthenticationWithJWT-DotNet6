...
namespace AuthServer.Business.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IOptions<List<Client>> clients, UserManager<UserApp> userManager, ITokenService tokenService, IUnitOfWork unitOfWork, IGenericRepository<UserRefreshToken> userRefreshTokenService)
        {
